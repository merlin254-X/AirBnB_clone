...
class HBNBCommand(cmd.Cmd):
    ...
    def do_quit(self, line):
        """
        Quit command for exiting the group
        """
        return True
    ...
    def do_destroy(self, line):
        """
        Delete command that deletes an instance based on the class name and id
        """
        splitline = split(line)
    ...
    def do_all(self, line):
        ...
        """
        str_list = []  # Corrected indentation here
                    ...
                    if splitline[0] == key.split(".")[0]:
                        ...
                        if len(split) == 1:
                            ...
                            for row in delim:
                                ...
                                key_value = row.split(':')
                                str_id = str(splitline[0]) + " " + str(id) + " " + str(key_value[0]) + str(key_value[1])
                                self.do_update(str_id)
